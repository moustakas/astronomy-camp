...
pro aycamp_plotconfig, plotnum, position, psfile=psfile, psclose=psclose, $
...
;   common aycamp_plotconfig, defcolor
...
; get the position vector
    position = aycamp_getposition(nx=nx1,ny=ny1,xmargin=xmargin1,$
...
; write out
    if (n_elements(psfile) ne 0) and (keyword_set(psclose) eq 0) then begin
       ...
       aycamp_plotfaves, /postscript, keynote=keynote, _extra=extra
