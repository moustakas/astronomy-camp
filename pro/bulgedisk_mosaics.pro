pro bulgedisk_mosaics, sextractor=sextractor, scamp=scamp, $
...
; JPEG
    if keyword_set(jpeg) then begin
       aycamp_do_jpeg, datapath+'M51_R.fits', datapath+'M51_V.fits', $
         datapath+'M51_B.fits', jpegfile=datapath+'M51_BVR.jpeg', $
         scales=[1.0,1.0,1.0]
;      aycamp_do_jpeg, datapath+'M101_R.fits', datapath+'M101_B.fits', $
;        datapath+'M101_B.fits', jpegfile=datapath+'M101_BR.jpeg', $
;        scales=[1.0,0.5,0.5]*1D11
    endif
