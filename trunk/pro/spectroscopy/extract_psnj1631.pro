...
pro extract_psnj1631
; jm11jun27ucsd - extract Psnj1631

    datapath = getenv('AYCAMP_DATA')+'2011/bok/'
    outpath = getenv('AYCAMP_DATA')+'2011/projects/psnj1631/'
    sensfuncfile = datapath+'sensfunc_2011.fits'
    
    root = 'PSNJ1631+41'
    infiles = file_search(datapath+'29jun11/Science/sci-29jun11.'+['034[7-8]','0350']+'.fits.gz')
    objid = [1,1,1]
...
;      fspecfile = datapath+'29jun11/Fspec/'+root+suffix+'.fits'
...
;      spec1dfile = datapath+'29jun11/spec1d/'+root+suffix+'.fits'
...
; page 1
    djs_plot, [0], [0], xrange=[3650,6900], yrange=[1,7], $
...
; page 2    
    ...
    pushd, outpath
    spawn, 'tar czvf psnj1631.tar.gz '+pdffile+' '+$
