...
;
; COMMENTS:
;   This routine is designed to be used in tandem with AYCAMP_PLOTCONFIG. 
;
; EXAMPLES:
;   plot, findgen(10), position=aycamp_getposition()
;
...
function aycamp_getposition, nx=nx, ny=ny, xpage=xpage, ypage=ypage, $
